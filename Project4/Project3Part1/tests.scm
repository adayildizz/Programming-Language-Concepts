(module tests mzscheme
  ...
  (define test-list
    '(
      ...
      (extra-test-case-1
       ;negates a nummber
       "let negate = proc (x) -(0,x) in (negate 10)" -10)
      ;; Recursive Print:
      ;; negate --> 1
      ...
      (extra-test-case-2
       ...
       "letrec times-1(y) =
          letrec times-2(x) = if zero?(x) 
          then 0 else -((times-2 -(x,1)), -(0,y)) in (times-2 3) in (times-1 4)" 12)
      ;; Recursive Print:
      ;; times-1 --> 1
      ;; ....times-2 --> 2
      ;; ........times-2 --> 3
      ...
      ;; ................times-2 --> 5
      (extra-test-case-3
       ;does integer devision by3
       "letrec divideby3(x) = if zero?(x)  
          then 0 else if zero?(-(x,1)) then 0 else if zero?(-(x,2)) then 0 else -((divideby3 -(x,3)), -1) in (divideby3 14)" 4)
      ;; divideby3 --> 1
      ;; ....divideby3 --> 2
      ;; ........divideby3 --> 3
      ;; ............divideby3 --> 4
